...
<body>
    ...
    <form action="Asubmit.php" method="post" id="profileForm">
        ...
        <div class="form-group">
            ...
            <input type="number" name="tenthMarks" id="tenthMarks" min="0" max="100" required>
        </div>
        <div class="form-group">
            <label for="interMarks">Intermediate Marks (%):</label>
            <input type="number" name="interMarks" id="interMarks" min="0" max="100" required>
        </div>
        <div class="form-group">
            <label for="backlogs">Backlogs:</label>
            <input type="number" name="backlogs" id="backlogs" min="0" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" name="percentage" id="percentage" step="0.01" min="0" max="100" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select name="pega" id="pega" required>
        ...
        <div class="form-group">
            ...
            <select name="apt" id="apt" required>
                <option value="">Select</option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
            </select>
